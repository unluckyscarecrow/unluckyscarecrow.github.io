...
const jobBaseData = {
    ...
    "Farmer": {name: "Farmer", maxXp: 50, income: 9},
    "Fisherman": {name: "Fisherman", maxXp: 50, income: 15},
    "Miner": {name: "Miner", maxXp: 50, income: 40},
    "Blacksmith": {name: "Blacksmith", maxXp: 50, income: 80},
    "Merchant": {name: "Merchant", maxXp: 50, income: 150},

    "Squire": {name: "Squire", maxXp: 50, income: 5},
    "Footman": {name: "Footman", maxXp: 50, income: 50},
    "Veteran footman": {name: "Veteran footman", maxXp: 50, income: 120},
    "Knight": {name: "Knight", maxXp: 50, income: 300},
    "Veteran knight": {name: "Veteran knight", maxXp: 50, income: 1000},
    "Elite knight": {name: "Elite knight", maxXp: 50, income: 3000},
    "Holy knight": {name: "Holy knight", maxXp: 50, income: 15000},
    "Legendary knight": {name: "Legendary knight", maxXp: 50, income: 50000},

    "Student": {name: "Student", maxXp: 50, income: 100},
    "Apprentice mage": {name: "Apprentice mage", maxXp: 50, income: 1000},
    "Mage": {name: "Mage", maxXp: 50, income: 7500},
    "Wizard": {name: "Wizard", maxXp: 50, income: 50000},
    "Master wizard": {name: "Master wizard", maxXp: 50, income: 250000},
    "Chairman": {name: "Chairman", maxXp: 50, income: 1000000},
}
